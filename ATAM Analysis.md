...
| **ID** | **Architectural Decision** | Explanation |
| :--- | :--- | :--- |
| **T1** | **AD2** | **Trade-off: Availability (RTO $\le 30$s) vs. Data Consistency:** Prioritizing fast recovery via Asynchronous Replication comes at the cost of accepting the risk of minor data loss (R2). |
