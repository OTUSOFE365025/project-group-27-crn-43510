...
| **Primary functional requirements** | UC-1: Query academic/administrative information<br>UC-2: Receive notifications and announcements<br>UC-3: Manage and publish course materials<br>UC-4: Access and analyze academic analytics<br>UC-5: Manage integrations and policies<br>UC-6: Authenticate and personalize user experience<br>UC-7: Monitor and maintain system health<br>UC-8: Synchronize institutional data |
