...
| **Primary functional requirements (key use cases)** | UC-1: Query academic/administrative information<br>UC-2: Receive notifications and announcements<br>UC-3: Manage and publish course materials<br>UC-4: Access and analyze academic analytics<br>UC-5: Manage integrations and policies<br>UC-6: Authenticate and personalize user experience<br>UC-7: Monitor and maintain system health<br>UC-8: Synchronize institutional data |
| **Quality attributes (summary)** | QA1: Performance<br>QA2: Usability<br>QA3: Modifiability<br>QA4: Security<br>QA5: Availability<br>QA6: Scalability<br>QA7: Reliability<br>QA8: Interoperability |
